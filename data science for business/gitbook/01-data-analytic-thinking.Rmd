...
```
  ...
  <div id="montyhall" class="collapse container">
  <hr>
<div class="container">Instead of trying to find an answer by reasoning we could write an algorithm that would play the game for us. Below you see one run. </div>
