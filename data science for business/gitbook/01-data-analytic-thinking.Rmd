...
<iframe width="560" height="315" src="https://www.youtube.com/embed/GbL-42kv5LI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
- *Describe the difference and relationships between Data Analytics, Analysis and Science*
...
```{r lu-fig, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='A process model for data-driven decision making taken from @lu2020data', message=TRUE, warning=TRUE, out.width='80%'}
knitr::include_graphics('images/lu.png')
```
